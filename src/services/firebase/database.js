...
class DatabaseService {
  ...
  async getProducts(filters = {}) {
    const queryFilters = {
      ...
      limitToFirst: filters.limit || BUSINESS_CONSTANTS.PAGINATION.DEFAULT_PAGE_SIZE,
      ...filters
    };
  ...
  async getProductsByCategory(categoryId, limit = BUSINESS_CONSTANTS.PAGINATION.DEFAULT_PAGE_SIZE) {
  ...
  async updateProduct(productId, updates) {
    return this.update(`products/${productId}`, updates);
  }
  ...
  async getAllOrders(filters = {}) {
    const queryFilters = {
      orderBy: { type: 'child', key: 'createdAt' },
      limitToFirst: filters.limit || BUSINESS_CONSTANTS.PAGINATION.ADMIN_PAGE_SIZE,
      ...filters
    };
  ...
  async searchProducts(searchTerm, filters = {}) {
    try {
      ...
      if (productsResult.success) {
        ...
        const limit = filters.limit || BUSINESS_CONSTANTS.PAGINATION.DEFAULT_PAGE_SIZE;
